...
Java_uk_lgl_modmenu_FloatingModMenuService_setTitleText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b>Criado por FREEZA MODS</b>")); //<--- ADICIONE QUALQUER NOME AQUÍ.
...
Java_uk_lgl_modmenu_FloatingModMenuService_setHeadingText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                      "<p style=\"color:green;\">Mod menu LGL</p> | "
                                      "https://youtube.com/@freezamods | Se inscreva no meu canal do youtube para não ficar de fora de novos conteudos relacionados à mods"
                                      "</marquee></b>"));
...
Java_uk_lgl_modmenu_FloatingModMenuService_settingsList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_Ajustes"),
            OBFUSCATE("-1_Toggle_Salvar preferencias"), //-1 is checked on Preferences.java
            OBFUSCATE("-3_Toggle_Vertical automatico"),
            OBFUSCATE("Category_Logcat"),
            OBFUSCATE("RichTextView_Salve o logcat caso ocorra algum bug e envie-o ao criador do mod. Limpe o logcat e tente reproduzir o bug novamente se o arquivo de log estiver muito grande."),
            OBFUSCATE("RichTextView_<small>Salvar o logcat não requer permissão de arquivo. Localização do logcat:"
                            "<br/>Android 11: /storage/emulated/0/Documents/"
                            "<br/>Android 10 e Inferiores: /storage/emulated/0/Android/data/(package name)/files/Mod Menu</small>"),
            OBFUSCATE("-4_Button_Salvar arquivo de logcat"),
            OBFUSCATE("-5_Button_Limpar logcat"),
            OBFUSCATE("Category_Menu"),
            OBFUSCATE("-6_Button_<font color='red'>Saír de Ajustes</font>"),
    };
